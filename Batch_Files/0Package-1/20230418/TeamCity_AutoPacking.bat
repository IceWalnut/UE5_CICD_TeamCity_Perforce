...
@if %errorlevel%==0 (
  ...
  call .\TeamCity_SendDingMsg.bat 1
  color 4
  pause
  exit /b 1
)

@title TeamCity_Packing.bat ......
call .\TeamCity_Packing.bat
@if %errorlevel%==0 (
  echo TeamCity_Packing.bat ok
  call .\TeamCity_SendDingMsg.bat 0
  exit /b 0
) else (
  echo TeamCity_Packing.bat error
  call .\TeamCity_SendDingMsg.bat 1
  color 4
  pause
  exit /b 1
