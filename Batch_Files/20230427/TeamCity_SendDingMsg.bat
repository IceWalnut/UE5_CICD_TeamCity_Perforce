...
set ifsucceed=%1
@REM copy UAT log to curr pkg log dir
copy %~dp0Engine\Programs\AutomationTool\Saved\Logs\Log.txt %~dp0Projects\t6\ArchivedBuilds\%currvernum%\log\AutomationToolLog.txt
